...
TEST(IEEE_FP16_VALUE, normalized_powers_of_2) {
	...
	EXPECT_EQ(min_po2_f16, fp32_to_fp16b_ieee(min_po2_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << min_po2_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(min_po2_value) << ", " <<
		"F16 = 0x" << std::setw(4) << min_po2_f16;

	float eighths_value;
	memcpy(&eighths_value, &eighths_f32, sizeof(eighths_value));
	EXPECT_EQ(eighths_f16, fp32_to_fp16b_ieee(eighths_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << eighths_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(eighths_value) << ", " <<
		"F16 = 0x" << std::setw(4) << eighths_f16;

	float quarter_value;
	memcpy(&quarter_value, &quarter_f32, sizeof(quarter_value));
	EXPECT_EQ(quarter_f16, fp32_to_fp16b_ieee(quarter_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << quarter_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(quarter_value) << ", " <<
		"F16 = 0x" << std::setw(4) << quarter_f16;

	float half_value;
	memcpy(&half_value, &half_f32, sizeof(half_value));
	EXPECT_EQ(half_f16, fp32_to_fp16b_ieee(half_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << half_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(half_value) << ", " <<
		"F16 = 0x" << std::setw(4) << half_f16;

	float one_value;
	memcpy(&one_value, &one_f32, sizeof(one_value));
	EXPECT_EQ(one_f16, fp32_to_fp16b_ieee(one_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << one_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(one_value) << ", " <<
		"F16 = 0x" << std::setw(4) << one_f16;

	float two_value;
	memcpy(&two_value, &two_f32, sizeof(two_value));
	EXPECT_EQ(two_f16, fp32_to_fp16b_ieee(two_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << two_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(two_value) << ", " <<
		"F16 = 0x" << std::setw(4) << two_f16;

	float four_value;
	memcpy(&four_value, &four_f32, sizeof(four_value));
	EXPECT_EQ(four_f16, fp32_to_fp16b_ieee(four_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << four_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(four_value) << ", " <<
		"F16 = 0x" << std::setw(4) << four_f16;

	float eight_value;
	memcpy(&eight_value, &eight_f32, sizeof(eight_value));
	EXPECT_EQ(eight_f16, fp32_to_fp16b_ieee(eight_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << eight_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(eight_value) << ", " <<
		"F16 = 0x" << std::setw(4) << eight_f16;

	float sixteen_value;
	memcpy(&sixteen_value, &sixteen_f32, sizeof(sixteen_value));
	EXPECT_EQ(sixteen_f16, fp32_to_fp16b_ieee(sixteen_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << sixteen_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(sixteen_value) << ", " <<
		"F16 = 0x" << std::setw(4) << sixteen_f16;

	float thirtytwo_value;
	memcpy(&thirtytwo_value, &thirtytwo_f32, sizeof(thirtytwo_value));
	EXPECT_EQ(thirtytwo_f16, fp32_to_fp16b_ieee(thirtytwo_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << thirtytwo_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(thirtytwo_value) << ", " <<
		"F16 = 0x" << std::setw(4) << thirtytwo_f16;

	float sixtyfour_value;
	memcpy(&sixtyfour_value, &sixtyfour_f32, sizeof(sixtyfour_value));
	EXPECT_EQ(sixtyfour_f16, fp32_to_fp16b_ieee(sixtyfour_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << sixtyfour_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(sixtyfour_value) << ", " <<
		"F16 = 0x" << std::setw(4) << sixtyfour_f16;
}

TEST(IEEE_FP16_VALUE, denormalized_powers_of_2) {
	...
	EXPECT_EQ(exp2_minus_15_f16, fp32_to_fp16b_ieee(exp2_minus_15_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_15_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_15_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_16_f16, fp32_to_fp16b_ieee(exp2_minus_16_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_16_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_16_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_17_f16, fp32_to_fp16b_ieee(exp2_minus_17_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_17_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_17_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_18_f16, fp32_to_fp16b_ieee(exp2_minus_18_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_18_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_18_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_19_f16, fp32_to_fp16b_ieee(exp2_minus_19_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_19_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_19_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_20_f16, fp32_to_fp16b_ieee(exp2_minus_20_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_20_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_20_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_21_f16, fp32_to_fp16b_ieee(exp2_minus_21_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_21_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_21_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_22_f16, fp32_to_fp16b_ieee(exp2_minus_22_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_22_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_22_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_23_f16, fp32_to_fp16b_ieee(exp2_minus_23_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_23_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_23_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_24_f16, fp32_to_fp16b_ieee(exp2_minus_24_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_24_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_24_value) << ", " <<
	...
	EXPECT_EQ(exp2_minus_25_f16, fp32_to_fp16b_ieee(exp2_minus_25_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << exp2_minus_25_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(exp2_minus_25_value) << ", " <<
		"F16 = 0x" << std::setw(4) << exp2_minus_25_f16;
}

TEST(IEEE_FP16_VALUE, zero) {
	...
	EXPECT_EQ(positive_zero_f16, fp32_to_fp16b_ieee(positive_zero_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << positive_zero_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(positive_zero_value) << ", " <<
	...
	EXPECT_EQ(negative_zero_f16, fp32_to_fp16b_ieee(negative_zero_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << negative_zero_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(negative_zero_value) << ", " <<
		"F16 = 0x" << std::setw(4) << negative_zero_f16;
}

TEST(IEEE_FP16_VALUE, infinity) {
	...
	EXPECT_EQ(positive_infinity_f16, fp32_to_fp16b_ieee(positive_infinity_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << positive_infinity_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(positive_infinity_value) << ", " <<
	...
	EXPECT_EQ(negative_infinity_f16, fp32_to_fp16b_ieee(negative_infinity_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << negative_infinity_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(negative_infinity_value) << ", " <<
...
TEST(IEEE_FP16_VALUE, positive_nan) {
	for (uint32_t nan_f32 = UINT32_C(0x7FFFFFFF); nan_f32 > UINT32_C(0x7F800000); nan_f32--) {
		...
		const uint16_t nan_f16 = fp32_to_fp16b_ieee(nan_value);
...
TEST(IEEE_FP16_VALUE, revertible) {
	/* Positive values */
	for (uint16_t f16 = UINT16_C(0x0001); f16 < UINT16_C(0x7C00); f16++) {
		const float value_f32 = fp16b_to_fp32_ieee(f16);
		uint32_t bits_f32;
		memcpy(&bits_f32, &value_f32, sizeof(bits_f32));

		ASSERT_EQ(f16, fp32_to_fp16b_ieee(value_f32)) <<
			std::hex << std::uppercase << std::setfill('0') <<
			"F16 = 0x" << std::setw(4) << f16 << ", " <<
			"F32(F16) = 0x" << std::setw(8) << bits_f32 << ", " <<
			"F16(F32(F16)) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(value_f32);
	}

	/* Negative values */
	for (uint16_t f16 = UINT16_C(0x8001); f16 < UINT16_C(0xFC00); f16++) {
		const float value_f32 = fp16b_to_fp32_ieee(f16);
		uint32_t bits_f32;
		memcpy(&bits_f32, &value_f32, sizeof(bits_f32));
...
TEST(IEEE_FP16_VALUE, underflow) {
	...
	for (uint32_t bits = UINT32_C(0x00000001); bits < min_nonzero_f32; bits++) {
		...
		ASSERT_EQ(zero_f16, fp32_to_fp16b_ieee(value)) <<
			std::hex << std::uppercase << std::setfill('0') <<
			"F32 = 0x" << std::setw(8) << bits << ", " <<
			"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(value) << ", " <<
			"F16 = 0x" << std::setw(4) << zero_f16;
	}
	float min_nonzero_value;
	memcpy(&min_nonzero_value, &min_nonzero_f32, sizeof(min_nonzero_value));
	ASSERT_EQ(min_f16, fp32_to_fp16b_ieee(min_nonzero_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << min_nonzero_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(min_nonzero_value) << ", " <<
		"F16 = 0x" << std::setw(4) << min_f16;
}

TEST(IEEE_FP16_VALUE, overflow) {
	...
	for (uint32_t bits = positive_infinity_f32; bits > max_finite_f32; bits--) {
		float value;
		memcpy(&value, &bits, sizeof(value));
		ASSERT_EQ(positive_infinity_f16, fp32_to_fp16b_ieee(value)) <<
			std::hex << std::uppercase << std::setfill('0') <<
			"F32 = 0x" << std::setw(8) << bits << ", " <<
			"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(value) << ", " <<
			"F16 = 0x" << std::setw(4) << positive_infinity_f16;
	...
	ASSERT_EQ(max_finite_f16, fp32_to_fp16b_ieee(max_finite_value)) <<
		std::hex << std::uppercase << std::setfill('0') <<
		"F32 = 0x" << std::setw(8) << max_finite_f32 << ", " <<
		"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(max_finite_value) << ", " <<
		"F16 = 0x" << std::setw(4) << max_finite_f16;
}

TEST(IEEE_FP16_VALUE, positive_denormalized_values) {
	const uint32_t min_nonzero_f32 = UINT32_C(0x33000001);
	...
	for (uint16_t f16 = 0; f16 < UINT16_C(0x0400); f16++) {
		...
		for (uint32_t f32 = f32_begin; f32 < f32_end; f32++) {
			...
			ASSERT_EQ(f16, fp32_to_fp16b_ieee(value)) <<
				std::hex << std::uppercase << std::setfill('0') <<
...
TEST(IEEE_FP16_VALUE, negative_denormalized_values) {
	const uint32_t min_nonzero_f32 = UINT32_C(0x33000001);
...
TEST(IEEE_FP16_VALUE, positive_normalized_values) {
...
TEST(IEEE_FP16_VALUE, negative_normalized_values) {
	/* Minimum number that rounds to 1.0h when converted to half-precision */
	const uint32_t min_one_f32 = UINT32_C(0x3F7FF000);
	const uint32_t e_bias = 15;
...
#if (defined(__i386__) || defined(__x86_64__)) && defined(__F16C__)
	TEST(IEEE_FP16_VALUE, match_hardware) {
		...
		for (uint32_t bits = min_nonzero; bits < max_finite; bits++) {
			...
			ASSERT_EQ(reference, fp32_to_fp16b_ieee(value)) <<
				std::hex << std::uppercase << std::setfill('0') <<
				"F32 = 0x" << std::setw(8) << bits << ", " <<
				"F16(F32) = 0x" << std::setw(4) << fp32_to_fp16b_ieee(value) << ", " <<
