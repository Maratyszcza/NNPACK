...
TEST(F6x6_3x3, input) {
	...
	tester.testInputTransform2D(nnp_iwt8x8_3x3_with_offset__scalar, inputTransformMatrix);
}
...
TEST(F6x6_3x3, kernel) {
	...
	tester.testKernelTransform2D(nnp_kwt8x8_3x3__scalar, kernelTransformMatrix);
}
