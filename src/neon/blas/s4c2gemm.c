...
void nnp_s4c2gemm_only_2x2__neon(
	...
	size_t row_stride_c)
{
	...
	do {
		...
		float32x4_t b0r = vld1q_f32(b +  0);
		float32x4_t b0i = vld1q_f32(b +  4);
		float32x4_t b1r = vld1q_f32(b +  8);
		float32x4_t b1i = vld1q_f32(b + 12);
		...
		acc00r = vcombine_f32(vget_low_f32(acc00r), vmulsub_f32(vget_high_f32(acc00r), vget_high_f32(a0i), vget_high_f32(b0i)));
		acc00i = vcombine_f32(vget_low_f32(acc00i), vmuladd_f32(vget_high_f32(acc00i), vget_high_f32(a0r), vget_high_f32(b0i)));
		acc10r = vcombine_f32(vget_low_f32(acc10r), vmulsub_f32(vget_high_f32(acc10r), vget_high_f32(a1i), vget_high_f32(b0i)));
		acc10i = vcombine_f32(vget_low_f32(acc10i), vmuladd_f32(vget_high_f32(acc10i), vget_high_f32(a1r), vget_high_f32(b0i)));

		acc01r = vcombine_f32(vget_low_f32(acc01r), vmulsub_f32(vget_high_f32(acc01r), vget_high_f32(a0i), vget_high_f32(b1i)));
		acc01i = vcombine_f32(vget_low_f32(acc01i), vmuladd_f32(vget_high_f32(acc01i), vget_high_f32(a0r), vget_high_f32(b1i)));
		acc11r = vcombine_f32(vget_low_f32(acc11r), vmulsub_f32(vget_high_f32(acc11r), vget_high_f32(a1i), vget_high_f32(b1i)));
		acc11i = vcombine_f32(vget_low_f32(acc11i), vmuladd_f32(vget_high_f32(acc11i), vget_high_f32(a1r), vget_high_f32(b1i)));
...
void nnp_s4c2gemm_upto_2x2__neon(
	...
	size_t row_stride_c)
{
	...
	do {
		...
		if (nr > 1) {
			float32x4_t b1r = vld1q_f32(b + 0);
			float32x4_t b1i = vld1q_f32(b + 4);
			b += 8;
